...
@NamedQueries({
    ...
    @NamedQuery(name = "Operations.findByOperationName", query = "SELECT o FROM Operations o WHERE o.operationName = :operationName"),
    @NamedQuery(name = "Operations.findByOperationDescription", query = "SELECT o FROM Operations o WHERE o.operationDescription = :operationDescription")})
public class Operations implements Serializable {
    ...
    public String toString() {
        return "com.corebits.ericsson.tms.models.Operations[ id=" + id + " ]";
    }
